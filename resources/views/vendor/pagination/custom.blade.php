@if ($paginator->hasPages() || true)
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="bg-white px-4 py-3 flex flex-col sm:flex-row items-center justify-between border-t border-gray-200 sm:px-6">
        <div class="flex flex-col sm:flex-row items-center mb-4 sm:mb-0">
            ...
            <span class="text-sm text-gray-700 mt-2 sm:mt-0 sm:ml-4">
