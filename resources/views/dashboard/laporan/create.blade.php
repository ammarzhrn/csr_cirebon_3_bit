                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="{{ url('/dashboard/laporan') }}" class="font-semibold text-sm text-gray-500 hover:text-gray-700">
                                {{ __('Laporan') }}
                            </a>
                            <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 9L5 5L1 1" stroke="#667085" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="space-y-6">
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-2xl sm:text-[28px] font-semibold leading-tight sm:leading-[44px] tracking-[-0.02em] text-left font-inter">Buat Laporan Baru</h2>
                        </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg w-full sm:w-[1240px] p-4 sm:p-6 space-y-6 border border-gray-200">
                            <form id="laporan-form" action="{{ route('dashboard.laporan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                                @csrf
                                <input type="hidden" name="id_user" value="{{ auth()->id() }}">
                                
                                <!-- Judul Laporan -->
                                <div class="space-y-2">
                                    <label for="judul_laporan" class="block text-sm font-semibold leading-5">Judul Laporan <span class="text-red-500">*</span></label>
                                    <input type="text" name="judul_laporan" id="judul_laporan" class="w-full h-12 px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" placeholder="Masukan nama laporan CSR" required>
                                </div>

                                <!-- Sektor and Program -->
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <label for="id_sektor" class="block text-sm font-semibold leading-5">Sektor CSR <span class="text-red-500">*</span></label>
                                    ...
                                    <div class="space-y-2">
                                        <label for="id_program" class="block text-sm font-semibold leading-5">Program CSR <span class="text-red-500">*</span></label>
                                ...
                                <!-- Nama Proyek -->
                                <div class="space-y-2">
                                    <label for="id_proyek" class="block text-sm font-semibold leading-5">Nama Proyek CSR</label>
                                    <select name="id_proyek" id="id_proyek" class="w-full h-12 px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                                    <div class="space-y-2">
                                        <label for="tanggal" class="block text-sm font-semibold leading-5">Tanggal <span class="text-red-500">*</span></label>
                                        <select name="tanggal" id="tanggal" class="w-full h-12 px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" required>
                                    ...
                                    <div class="space-y-2">
                                        <label for="bulan" class="block text-sm font-semibold leading-5">Bulan <span class="text-red-500">*</span></label>
                                        <select name="bulan" id="bulan" class="w-full h-12 px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" required>
                                    ...
                                    <div class="space-y-2">
                                        <label for="tahun" class="block text-sm font-semibold leading-5">Tahun <span class="text-red-500">*</span></label>
                                        <select name="tahun" id="tahun" class="w-full h-12 px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" required>
                                    ...
                                    <div class="space-y-2">
                                        <label for="realisasi" class="block text-sm font-semibold leading-5">Realisasi <span class="text-red-500">*</span></label>
                                        <input type="number" name="realisasi" id="realisasi" class="w-full h-12 px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" placeholder="Rp 0" required>
                                    </div>
                                </div>

                                <!-- Deskripsi -->
                                <div class="space-y-2">
                                    <label for="deskripsi" class="block text-sm font-semibold leading-5">Deskripsi</label>
                                    <textarea name="deskripsi" id="deskripsi" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm" placeholder="Deskripsi"></textarea>
                                </div>

                                <!-- Foto Laporan -->
                                <div class="space-y-2">
                                    <label class="block text-sm font-semibold leading-5">Foto Laporan Kegiatan <span class="text-red-500">*</span></label>
                                    <div id="image-container" class="mt-2 flex flex-wrap gap-4">
                                        <div id="upload-box" class="w-full sm:w-[300px] h-[183.29px] border border-gray-300 border-dashed rounded-lg flex items-center justify-center cursor-pointer overflow-hidden relative">
                        ...
                        <div class="bg-white w-full sm:w-[1240px] px-4 sm:px-6 py-4 mt-6 border border-gray-200 rounded-lg shadow-sm">
                            <div class="flex flex-col sm:flex-row justify-end items-center space-y-4 sm:space-y-0 sm:space-x-4">
                                ...
                                <button type="submit" form="laporan-form" name="save_draft" value="1" class="flex items-center justify-center w-full sm:w-[232px] h-                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-2">
                                ...
                                <!-- Tombol Submit -->
                                <button type="submit" form="laporan-form" id="submit-button" class="flex items-center justify-center w-full sm:w-[119px] h-[52px] px-[18px] py-[10px] gap-2 rounded-lg border border-[#98100A] bg-[#98100A] text-white shadow-sm hover:bg-[#7d0d08] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#98100A]">
            ...
            if (input.files && input.files.length > 0) {
                for (let i = 0; i < Math.min(input.files.length, maxImages - currentImages); i++) {
                    ...
                    reader.onload = function(e) {
                        ...
                        div.className = 'w-full sm:w-[300px] h-[183.29px] rounded-lg overflow-hidden relative image-preview';
                        div.style.opacity = '1';
                        div.innerHTML = `
