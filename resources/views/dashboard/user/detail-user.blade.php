                    ...
                    <div class="space-y-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="flex flex-row space-x-4">
                               <a href="{{ route('dashboard.user.edit', $summary->id) }}" class="flex items-center justify-center w-[150px] h-[52px] px-[18px] py-[10px] gap-2 rounded-lg border border-[#98100A] bg-[#98100A] text-white hover:bg-[#7a0d08] focus:ring-4 focus:ring-red-300 font-medium text-sm shadow-[0px_1px_2px_0px_#1018280D]">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            @if ($summary->user->level == 'guest')
                            <form action="{{ route('user.active', $summary->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin mengaktifkan user ini?');">
                                @csrf
                                <button type="submit" class="flex items-center justify-center w-[200px] h-[52px] px-[18px] py-[10px] gap-2 rounded-lg border border-[#027A48] bg-[#ffff] text-[#027A48] hover:bg-[#e8fff6] focus:ring-4 focus:ring-green-300 font-medium text-sm shadow-[0px_1px_2px_0px_#1018280D]">
                                    <svg fill="#027A48" height="25px" width="25px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 198.715 198.715" xml:space="preserve"><g>
                                    <path d="M161.463,48.763c-2.929-2.929-7.677-2.929-10.607,0c-2.929,2.929-2.929,7.677,0,10.606c13.763,13.763,21.342,32.062,21.342,51.526c0,19.463-7.579,37.761-21.342,51.523c-14.203,14.204-32.857,21.305-51.516,21.303c-18.659-0.001-37.322-7.104-51.527-21.309c-28.405-28.405-28.402-74.625,0.005-103.032c2.929-2.929,2.929-7.678,0-10.606c-2.929-2.929-7.677-2.929-10.607,0C2.956,83.029,2.953,138.766,37.206,173.019c17.132,17.132,39.632,25.697,62.135,25.696c22.497-0.001,44.997-8.564,62.123-25.69c16.595-16.594,25.734-38.659,25.734-62.129C187.199,87.425,178.059,65.359,161.463,48.763z"/>
                                    <path d="M99.332,97.164c4.143,0,7.5-3.358,7.5-7.5V7.5c0-4.142-3.357-7.5-7.5-7.5s-7.5,3.358-7.5,7.5v82.164C91.832,93.807,95.189,97.164,99.332,97.164z"/></g>
                                    </svg>
                                    Aktifkan User
                                </button>
                            </form>
                            @else
                            <form action="{{ route('user.deactivate', $summary->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menonaktifkan user ini?');">
                                @csrf
                                <button type="submit" class="flex items-center justify-center w-[200px] h-[52px] px-[18px] py-[10px] gap-2 rounded-lg border border-[#98100A] bg-[#ffff] text-[#98100A] hover:bg-[#ffe0de] focus:ring-4 focus:ring-red-300 font-medium text-sm shadow-[0px_1px_2px_0px_#1018280D]">
                                    <svg fill="#98100A" height="25px" width="25px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 198.715 198.715" xml:space="preserve"><g>
                                    <path d="M161.463,48.763c-2.929-2.929-7.677-2.929-10.607,0c-2.929,2.929-2.929,7.677,0,10.606c13.763,13.763,21.342,32.062,21.342,51.526c0,19.463-7.579,37.761-21.342,51.523c-14.203,14.204-32.857,21.305-51.516,21.303c-18.659-0.001-37.322-7.104-51.527-21.309c-28.405-28.405-28.402-74.625,0.005-103.032c2.929-2.929,2.929-7.678,0-10.606c-2.929-2.929-7.677-2.929-10.607,0C2.956,83.029,2.953,138.766,37.206,173.019c17.132,17.132,39.632,25.697,62.135,25.696c22.497-0.001,44.997-8.564,62.123-25.69c16.595-16.594,25.734-38.659,25.734-62.129C187.199,87.425,178.059,65.359,161.463,48.763z"/>
                                    <path d="M99.332,97.164c4.143,0,7.5-3.358,7.5-7.5V7.5c0-4.142-3.357-7.5-7.5-7.5s-7.5,3.358-7.5,7.5v82.164C91.832,93.807,95.189,97.164,99.332,97.164z"/></g>
                                    </svg>
                                    Non-Aktifkan User
                                ...
                                <div class="flex flex-col md:flex-row justify-between">
                                    <div class="w-full md:w-5/12 mb-4 md:mb-0">
                                        <div class="w-full h-[300px] rounded-xl bg-[#E7EEF7] flex items-center justify-center relative">
                                            <img src="{{ $summary->foto_pp ? asset('storage/images/profile/' . $summary->foto_pp) : asset('storage/images/profile/profile.png') }}" alt="Foto Profil" class="max-w-full max-h-full object-contain rounded-xl">
                                        </div>
                                    </div>
                                    <div class="w-full md:w-6/12">
                                        <div class="w-full space-y-4">
                                            <h3 class="text-2xl font-semibold">
                                                {{ $summary->nama_mitra ?? 'Nama Mitra belum diisi' }}

                                                @if($summary->user->level == 'guest')
                                                <span class="p-2 inline-flex text-base leading-5 font-semibold rounded-md bg-[#FEF3F2] text-[#B42318]">
                                                    Non Aktif
                                                </span>
                                                @else
                                                <span class="p-2 inline-flex text-base leading-5 font-semibold rounded-md bg-[#ECFDF3] text-[#027A48]">
                                                    Aktif
                                                </span>
                                                @endif
                                            </h3>

                                            <p class="text-xl text-gray-600">{{ $summary->nama }}</p>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <span>{{$summary->no_telp ?? 'Nomor telepon belum diisi' }}</span>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <span>{{ $summary->alamat ?? 'Alamat belum diisi' }}</span>
                                                </div>
                                            <h3 class="text-xl font-semibold">Deskripsi</h3>
                                            <p class="text-gray-700">
                                                {{$summary->deskripsi ?? 'Deskripsi belum ditambahkan' }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
