...
<head>
    ...
    <title>Dashboard Admin CSR Pemerintah Kabupaten Cirebon</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="subtitle">Dashboard Admin Corporate Social Responsibility (CSR)</div>
    </div>
    ...
    <div class="summary-box">
        ...
        <p>Total Dana Realisasi: {{ $formattedDanaRealisasiFull }}</p>
    </div>

    <h2>Data per Sektor</h2>
    <table>
        <thead>
            <tr>
                <th>Sektor</th>
